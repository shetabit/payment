...
return [
    ...
    */
    'drivers' => [
        ...
        'saderat' => [
            'apiPurchaseUrl' => 'https://mabna.shaparak.ir:8080',
            'apiPaymentUrl' => 'https://Saderat.shaparak.ir:8080/Pay/',
            'apiVerificationUrl' => 'https://mabna.shaparak.ir:8081/V1/PeymentApi/Advice/',
            'apiRollbackUrl' => 'https://mabna.shaparak.ir:8081/V1/PeymentApi/RollBack/',
            'terminalId' => '',
            'callbackUrl' => 'http://yoursite.com/path/to',
            'description' => 'payment in '.config('app.name'),
        ],
    ...
    */
    'map' => [
        ...
        'sadad' => \Shetabit\Payment\Drivers\Sadad::class,
